...
#### Step 1: 원본 사진 준비
1. 웨딩 사진들을 `public/images-src/` 폴더에 추가합니다.
2. 파일명이 자동으로 정렬되므로, 원하는 순서대로 정렬될 수 있도록 파일명을 지어줍니다.
   - 예: `DSC00001.jpg`, `DSC00002.jpg`, ... 또는 `photo_01.jpg`, `photo_02.jpg`, ...

#### Step 2: 스크립트 실행
터미널에서 다음 명령어를 실행하여 이미지를 최적화하고 WebP로 변환합니다:
